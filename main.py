...
def main():
    ...
    while True:  # infinite loop for webcam video capture
        ...
        if lms:  # process the frame only if at least a face is found
            ...
            if tired:
                ct = datetime.now()
                formatted_timestamp = ct.strftime('%Y%m%d%H%M%S')  # Format timestamp without invalid characters

                # Use forward slashes or a raw string to avoid escape character issues
                filename = f'save/Tired-{formatted_timestamp}.jpg'
            ...
            if asleep:
                ...
                # Use forward slashes or a raw string to avoid escape character issues
                filename = f'save/Asleep-{formatted_timestamp}.jpg'
            ...
            if looking_away:
                ...
                # Use forward slashes or a raw string to avoid escape character issues
                filename = f'save/Looking-away-{formatted_timestamp}.jpg'
            ...
            if distracted:
                ...
                # Use forward slashes or a raw string to avoid escape character issues
                filename = f'save/Distracted-{formatted_timestamp}.jpg'
